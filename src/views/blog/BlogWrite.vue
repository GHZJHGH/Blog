      ...
      >
        ...
        <div slot="footer" class="dialog-footer">
          <el-button type="primary" @click="publish('articleForm')"
            >发布</el-button
          >
          <el-button type="danger" @click="publishVisible = false"
            >取 消</el-button
          >
        </div>
      </el-dialog>
    ...
    publish(articleForm) {
      ...
      this.$refs[articleForm].validate((valid) => {
        if (valid) {
          ...
          this.judgeSensitiveWord(this.articleForm.title);
          this.judgeSensitiveWord(this.articleForm.editor.value);
          this.judgeSensitiveWord(this.articleForm.summary);
