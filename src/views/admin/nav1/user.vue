      ...
      <el-table-column label="操作" width="250">
        <template slot-scope="scope">
          ...
          <el-button
            type="primary"
            size="small"
            @click="unDel(scope.$index, scope.row)"
            :disabled = !scope.row.deleted
            >取消拉黑</el-button
          >
        </template>
    ...
    >
      ...
      >
        <el-form-item label="名称" prop="userName">
          <el-input type="textarea" v-model="addForm.userName"></el-input>
        </el-form-item>
        <el-form-item label="图标">
          <el-upload
            class="upload-demo"
...
export default {
  ...
  methods: {
    ...
    unDel: function (index, row) {
      this.$confirm("确认取消拉黑该用户吗?", "提示", {
        type: "warning",
      })
        .then(() => {
          this.listLoading = true;
